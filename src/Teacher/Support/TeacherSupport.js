                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-12">
                                                <div className="view-btn">
                                                    <button id="discard" type="button" className="btn btn-reset me-2" data-bs-dismiss="offcanvas" onClick={() => formik1.resetForm()} >
                                                        Discard
                                                    </button>
        ...
        />
                                    ...
                                    {supportTicket?.support_ticket_replies
                                        ...
                                        supportTicket.support_ticket_replies.map(
                                            (data, i) => {
                                                return (
                                                    <div key={i} style={{ borderStyle: "solid", borderWidth: "thin", borderColor: "aquamarine", borderRadius: "1rem", padding: "1.5rem 1rem", marginBottom: "2rem" }}>
                                                        <Row>
                                                            <Col md={12}>
                                                                <strong>
                                                                    {
