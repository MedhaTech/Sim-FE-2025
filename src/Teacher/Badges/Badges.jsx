...
const BadgesComp = () => {
  ...
  const dataOf = [
    t("badges.enableAfter5Teams"),
    t("badges.enableAfter10Teams"),
    t("badges.enableAfterAllTeamsSubmitIdeas"),
    t("badges.enableAfterWinAll3Badges"),
  ];
  useEffect(() => {
    badgesfetch();
  }, [language]);
