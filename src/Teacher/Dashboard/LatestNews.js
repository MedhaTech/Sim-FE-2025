    ...
    return(
        <div className="card flex-fill default-cover mb-4 latest-news-container">
            <div className="card-header d-flex justify-content-between align-items-center">
                <h4 className="card-title mb-0">Latest News <FaNewspaper size={30} style={{marginLeft:"6px"}} /> </h4>
                            ...
                            {news?.map((item, index) => (
                                <tr key={index}>
                                    <td className="productimgname">
                                        <span className="ps-2 d-flex align-items-center"style={{marginRight:"5px"}}>
