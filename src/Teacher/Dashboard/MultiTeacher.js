...
// console.log(teamsCount,"tC",ideaCount,"ic",approveideaCount,"ac");
    ...
    },
    {
      ...
      icon:
        teamsCount > 0 ? (
          ...
          <BiLogoMicrosoftTeams color="brown" />
        ),
    },
    {
      ...
      icon:
        studentCount > 0 ? (
          ...
          <PiStudentFill style={{ color: "purple" }} />
        ),
    },
    {
    ...
    },
    {
      ...
      icon:
        postdata === "Completed" ? (
          ...
          <FiEdit3 color="sky blue" />
        ),
    },
    {
      name: t("teacherJourney.add7"),
      status:
        postdata === "Completed" && ideaCount >= 1 ? "Completed" : "Disabled",
      icon:
        postdata === "Completed" && ideaCount >= 1 ? (
          <FaFlagCheckered color="green" />
        ) : (
          <LiaCertificateSolid color="green" />
        ),
    },
  ];
  ...
  return (
    <div
      className="card flex-fill default-cover mb-4 latest-news-container"
      style={{
        border: "none",
        outline: "none",
          ...
          {steps.map((step, index) => (
            <div key={step.name} className="roadmap-step">
              ...
              {index < steps.length - 1 && (
                <div
                  className={`step-line ${
                    step.status === "Completed" ? "completed-line" : ""
                  }`}
                />
              )}
            </div>
